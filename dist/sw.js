...
var urlsToCache = ["/", "/styles.css", "/index.js", "/fileserver/backend/uploads/abertura.mp4"]; // https://developers.google.com/web/fundamentals/primers/service-workers/?hl=pt-br
...
self.addEventListener("install", function (event) {
  ...
  event.waitUntil(caches.open(CACHE_NAME).then(function (cache) {
    ...
    return cache.addAll(['/', '/index.js', '/fileserver/backend/uploads/abertura.mp4', '/styles.css']);
  }));
});
