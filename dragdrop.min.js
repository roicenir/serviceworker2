          ...
          b.exports = function(a, b) {
            ...
            function f(c) {
              if (
                (c.stopPropagation(),
                c.preventDefault(),
                b.onDragOver && b.onDragOver(c),
                c.dataTransfer.items)
              ) {
                const a = Array.from(c.dataTransfer.items),
                  d = a.filter(a => "file" === a.kind),
                  e = a.filter(a => "string" === a.kind);
                if (0 === d.length && !b.onDropText) return;
                if (0 === e.length && !b.onDrop) return;
            ...
            function h(a) {
              ...
              if (
                (f && b.onDropText && b.onDropText(f, e),
                b.onDrop && a.dataTransfer.items)
              ) {
                const f = a.dataTransfer.files,
                  g = Array.from(a.dataTransfer.items).filter(
                    a => "file" === a.kind
                  );
                ...
                d(
                  ...
                  (a, c) => {
                    if (a) throw a;
                    const d = c.flat(),
                      g = d.filter(a => a.isFile),
                      h = d.filter(a => a.isDirectory);
                    b.onDrop(g, e, f, h);
                  }
                );
              }
            ...
            if ("string" == typeof a) {
              const b = a;
              if (((a = window.document.querySelector(a)), !a))
                throw new Error(`"${b}" does not match any HTML elements`);
            }
            if (!a) throw new Error(`"${a}" is not a valid HTML element`);
            "function" == typeof b && (b = { onDrop: b });
            let j;
            return (
              a.addEventListener("dragenter", e, !1),
              a.addEventListener("dragover", f, !1),
              a.addEventListener("dragleave", g, !1),
              a.addEventListener("drop", h, !1),
              function() {
                i(),
                  a.removeEventListener("dragenter", e, !1),
                  a.removeEventListener("dragover", f, !1),
                  a.removeEventListener("dragleave", g, !1),
                  a.removeEventListener("drop", h, !1);
              }
            );
          };
          const d = a("run-parallel");
        },
        { "run-parallel": 2 }
      ]
    },
